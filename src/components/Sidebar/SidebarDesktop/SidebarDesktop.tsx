...
const SidebarDesktop = () => {
  ...
  return (
    <aside
      className={twMerge(
        'w-full overflow-hidden lg:flex fixed left-0 top-0 bottom-0 bg-primary rounded-r-[10px] border-primary p-[24px]! transition-all flex-col justify-between items-center gap-[40px] z-[99]',
